        ...
        >
          <DataGrid
            rows={(allPurchases || [])?.map((item, index) => ({
              ...
              itemCode: item.purchaseItems?.itemDetails?.itemCode || "No Data",
              ...
              batchNo: item.purchaseItems?.itemDetails.batchNo || "No Data",
              ...
              mrp: item.purchaseItems?.itemDetails?.mrp || 0,
              ...
              purchaseRate: item.purchaseItems?.itemDetails?.purchaseRate || 0,
              saleRate: item.purchaseItems?.itemDetails?.saleRate || 0,
